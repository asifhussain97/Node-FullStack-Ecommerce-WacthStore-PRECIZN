...
let dailySessionsArray = document.getElementById("dailySessionsArray").value;
...
var myLineChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            ...
            pointHitRadius: 50,
            pointBorderWidth: 2,
            data: dailySessionsArray, // Use the array directly here
        }],
    },
    options: {
        scales: {
            ...
            yAxes: [{
                ticks: {
                    min: 0,
                    max: Math.max(...dailySessionsArray), // Dynamically set the max value based on data
                    maxTicksLimit: 5
                },
                gridLines: {
